#!/bin/bash
#
# Stress-grayscott the custom Load Balancer to trigger AutoScaler scale-out.
#
# Usage:
#   bash tests-checkpoint/stress-grayscott.sh
#   CNV_HOST=<lb-dns>:8080 bash tests-checkpoint/stress-grayscott.sh
...
wait
echo ""
echo "Grayscott stress test complete."
